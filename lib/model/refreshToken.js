...
/**
 * Fetches refreshToken for the client-user pair
 * Should be implemented with server logic
 *
 * @param userId {String} Unique identifier
 * @param clientId {String} Unique identifier
 * @param cb {Function} Function callback ->(error, token)
 */
module.exports.fetchByUserIdClientId = function(userId, clientId, cb) {
    throw new error.serverError('RefreshToken model method "fetchByUserIdClientId" is not implemented');
};

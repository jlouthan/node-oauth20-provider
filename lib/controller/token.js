        ...
        function(cb) {
            switch (grantType) {
                case 'authorization_code':
                    token.authorizationCode(req.oauth2, client, body.code, body.redirect_uri, cb);
                    break;
                case 'password':
                    token.password(req.oauth2, client, body.username, body.password, body.scope, cb);
                    break;
                case 'client_credentials':
                    token.clientCredentials(req.oauth2, client, body.scope, cb);
                    break;
                case 'refresh_token':
                    token.refreshToken(req.oauth2, client, body.refresh_token, body.scope, cb);
                    break;
                default:
